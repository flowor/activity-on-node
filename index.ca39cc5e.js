...
let network = new (0, _network.Network)();
let activityA = new (0, _activity.Activity)("A", "Decide topic and scope", 1);
let activityB = new (0, _activity.Activity)("B", "Collect Data", 2);
let activityC = new (0, _activity.Activity)("C", "Search the Internet", 3);
let activityD = new (0, _activity.Activity)("D", "Write the report", 5);
...
},{"./activity":"hcpTR","./network":"5I7AL"}],"hcpTR":[function(require,module,exports) {
...
class Activity {
    ...
    addImmediatePredecessor(activity) {
     ...
     */ getEarlyStart() {
        if (this.getPredecessorCount() === 0) return 0;
     ...
     */ getLateStart() {
        if (this.getPredecessorCount() === 0) return this.getEarlyStart();
     ...
     */ getLateFinish() {
        if (this.getSuccessorCount() === 0) return this.getEarlyFinish();
...
},{}],"5I7AL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Network {
    ...
    /* Return the size of this container */ size() {
        return this._size;
    }
    /* Return true if and only if this container has no Elements */ isEmpty() {
        return this._size === 0;
    }
    ...
    removeActivity(activity) {
        ...
        if (targetIndex < 0) throw new Error("Activity does not exist in this Network.");
        else {
            this._activities.splice(targetIndex, 1);
            this._size--;
        }
    }
    getProjectCompetionTime() {
